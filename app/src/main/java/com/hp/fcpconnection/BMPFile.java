...
public class BMPFile {
	...
	public void saveBitmap(OutputStream fos, byte[] imagePix, int parWidth,
						   int parHeight) {
	 ...
	 * writes the image.
	 */
	private void save(OutputStream fos, byte[] imagePix, int parWidth,
			int parHeight) {
	 ...
	 */
	private void writeBitmapFileHeader(OutputStream fos) {
	...
	private void writeBitmapInfoHeader(OutputStream fos) {
		try {
	...
	private void writePixelArray(OutputStream fos) {
		try {
